...
export default function OrdersScreen() {
  return (
    <AuthGate title="طلباتي" reason="سجّل الدخول لعرض سجل طلبات الجملة الخاصة بك.">
      <OrdersContent />
    </AuthGate>
  );
}
...
function OrdersContent() {
  ...
  return (
    <Screen>
      <ScreenHeader title="طلباتي" subtitle="سجل طلبات الجملة" />
        ...
        ListEmptyComponent={
          query.isLoading ? (
            ...
            <EmptyState
              ...
              description="ستظهر هنا كل طلبات الجملة التي ترسلها."
