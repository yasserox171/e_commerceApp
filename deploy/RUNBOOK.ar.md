...
| 3 | اسم نطاق فرعي مثل `api.your-domain.ma` وسجلّ `A` يشير إلى عنوان السيرفر | ضروري لشهادة HTTPS |
...
| Caddy لا يستخرج شهادة | سجلّ `A` لا يشير إلى السيرفر، أو المنفذ 80 مغلق | `dig +short api.your-domain.ma` و `sudo ufw status` |
